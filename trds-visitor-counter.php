 ...
 * Plugin URI: https://github.com/wikiwyrhead/trds-visitor-counter
 * Description: Counts daily and monthly visits, provides shortcode functionality to display the counts anywhere on the site, and includes customization options for visitor count displays.
 * Version: 1.1
 * Author: Arnel Go
 * Author URI: https://arnelgo.info/
 * License: GPLv2 or later
 * Text Domain: trds-website-visitor-counter
 */
